# [Reto #5: ⏱️ La cuenta atrás para el despegue](https://adventjs.dev/es/challenges/2025/5)
![Reto #5: ⏱️ La cuenta atrás para el despegue](https://adventjs.dev/backgrounds/5.webp)
...
* Convierte el formato elfo a un timestamp primero.
  El sufijo `NP` indica la hora oficial del Polo Norte (sin husos horarios ni DST), así que se trata como UTC.
* Usa diferencias en **segundos**, no milisegundos.
