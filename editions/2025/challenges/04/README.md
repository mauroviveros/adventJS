# [Reto #4: 🧮 Descifra el PIN de Santa](https://adventjs.dev/es/challenges/2025/4)
![Reto #4: 🧮 Descifra el PIN de Santa](https://adventjs.dev/backgrounds/4.webp)
...
Un bloque normal tiene la forma `[nOP...]`, donde:

* `n` es un número (0–9)
* después puede haber una lista de operaciones (opcionales)
...
El resultado siempre es un dígito (**aritmética mod 10**), por ejemplo:

* `9 + 1 → 0`
* `0 - 1 → 9`

También existe el bloque especial:

* `[<]` → repite el dígito del bloque anterior
