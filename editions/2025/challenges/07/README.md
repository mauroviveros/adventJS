# [Reto #7: 🎄 Montando el árbol](https://adventjs.dev/es/challenges/2025/7)
![Reto #7: 🎄 Montando el árbol](https://adventjs.dev/backgrounds/7.webp)
...
**Cuidado:** nunca debe haber espacios en blanco al final de cada línea.
